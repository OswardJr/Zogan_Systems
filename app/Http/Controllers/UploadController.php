...
class UploadController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        public function getImages($placa)
        {
          ...
          $desarmado = array();$latoneria= array();$pintura = array();$preparacion = array();$pulitura = array();$limpieza= array();$recepcion = array();
           ...
           foreach ($results as $value) {
            ...
            $array = array('desarmado'=>$desarmado,'latoneria'=>$latoneria,'pintura'=>$pintura,'preparacion'=>$preparacion,'pulitura'=>$pulitura,'limpieza'=>$limpieza);      
        }
      ...
      public function upload(Request $request)
      {
       ...
       $rev->ordenes_id = $request->_idAuto;
