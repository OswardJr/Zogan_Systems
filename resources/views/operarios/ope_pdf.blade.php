...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Operarios Totales</h3>
...
<thead>
  <tr>
    ...
    <th style="width:100px;text-align:center;">Apellido</th>
    <th style="width:100px;text-align:center;">Teléfono</th>
    <th style="width:100px;text-align:center;">Labor</th>
  </tr>
</thead>
                  @foreach ($operarios as $opes)

<tr>
  <td style="width:100px;text-align:center;">{{ $opes->cedula }}</td>
  <td style="width:100px;text-align:center;">{{ $opes->nombre }}</td>
  <td style="width:100px;text-align:center;">{{ $opes->apellido }}</td>
  <td style="width:100px;text-align:center;">{{ $opes->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $opes->tipo }}</td>
</tr>
                  @endforeach
