                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="panel-body ">
                                  <form method="post" name="crear" id="crear" action=" {{ url('/operarios/') }}/{{ $operarios->id }}">
                                   ...
                                   <div class="form-group col-md-6 " style="margin-bottom: 0px; height: 60px">
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="nombre" value="{{ $operarios->nombre }}" id="" class="form-control" placeholder="José" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="apellido" value="{{ $operarios->apellido }}" id="" class="form-control" placeholder="Pérez" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" maxlength="11" name="telefono" value="{{ $operarios->telefono }}" id="" pattern="^([0-9]{4})([0-9]{7})$" class="form-control" onkeypress="return justNumbers(event);" title="El formato debe ser 02441234567" placeholder="0244XXXXXXX" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      <div class="form-group @if ($errors->has('email')) has-error @endif">                                     
                                      <label>Email<a class="campos-required" title="Campo Obligatorio."> *</a></label>
                                      <input type="email" name="email" value="{{ $operarios->email }}" id="email" class="form-control" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" title="El formato debe ser contact@example.com" placeholder="contact@example.com" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      <div class="form-group @if ($errors->has('tipo')) has-error @endif">                                     
                                      <label>Tipo</label>
                                      <select class="form-control" name="tipo" value="{{ $operarios->tipo }}" required="true">
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <textarea type="text" name="direccion" value="{{ $operarios->direccion }}" id="" class="form-control" placeholder="Dirección" onkeyup="this.value=this.value.toUpperCase()" required="true">{{ $operarios->direccion }}</textarea>
                                    </div>
                                  </div>  
