                                  ...
                                  <form method="post" name="crear" id="crear" action=" {{ url('/operarios/') }}/{{ $operarios->id }}">
                                   ...
                                   <div class="form-group col-md-6 " style="margin-bottom: 0px; height: 60px">
                                      ...
                                      <div class="input-group input-group-sm">
                                        <input type="text" name="cedula" value="{{ $operarios->cedula }}" id="" class="form-control " pattern="^([JVEG]{1})-([0-9]{8})$" title="El formato debe ser V-12345678"  placeholder="V12345678" onkeyup="this.value=this.value.toUpperCase()" required="true" >
