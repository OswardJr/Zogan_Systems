                                  ...
                                  <form method="post" name="crear" id="crear" action=" {{ url('/operarios/') }}/{{ $operarios->id }}">
                                   ...
                                   <div class="form-group col-md-6 " style="margin-bottom: 0px; height: 60px">
                                      ...
                                      <div class="input-group input-group-sm">
                                        <input type="text" name="cedula" value="{{ $operarios->cedula }}" id="" class="form-control " pattern="^([JVEG]{1})-([0-9]{8})$" title="El formato debe ser V-12345678"  placeholder="V12345678" onkeyup="this.value=this.value.toUpperCase()" required="true" readonly>
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="telefono" value="{{ $operarios->telefono }}" id="" pattern="^([0-9]{4})-([0-9]{7})$" class="form-control" placeholder="0244-XXXXXXX" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      <div class="form-group @if ($errors->has('email')) has-error @endif">                                     
                                      <label>Email</label>
                                      <input type="email" name="email" value="{{ $operarios->email }}" id="email" class="form-control" placeholder="contact@example.com" onkeyup="this.value=this.value.toUpperCase()" required="true">
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
