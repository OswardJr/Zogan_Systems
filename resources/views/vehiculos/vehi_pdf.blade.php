...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Vehículos Totales</h3>
...
<tr>
  <td style="width:100px;text-align:center;">{{ $vehi->placa }}</td>
  <td style="width:100px;text-align:center;">{{ $vehi->marca }}</td>
  <td style="width:100px;text-align:center;">{{ $vehi->modelo }}</td>
  <td style="width:100px;text-align:center;">{{ $vehi->color }}</td>
</tr>
                  @endforeach
