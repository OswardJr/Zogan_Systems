...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Analistas Totales</h3>
...
<tr>
  <td style="width:100px;text-align:center;">{{ $anali->rif }}</td>
  <td style="width:100px;text-align:center;">{{ $anali->nombre }}</td>
  <td style="width:100px;text-align:center;">{{ $anali->apellido }}</td>
  <td style="width:100px;text-align:center;">{{ $anali->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $anali->email }}</td>
</tr>
                  @endforeach
