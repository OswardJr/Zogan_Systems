...
h3 {
  ...
  <tr>
    ...
    <td style="width:100px;text-align:center;font-weight: normal;white-space: nowrap;color: #5D6975;padding: 5px 20px;">Año: {{ $reparacione->anio}}</td>
     ...
     <tr>
    <td colspan="4" style="text-align:center;background:#F5F5F5;font-weight: normal;white-space: nowrap;color: #5D6975;padding: 5px 20px;">Estatus de las Reparaciones: <strong>Finalizado</strong></td>
    </tr>
