...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Repuestos Totales</h3>
...
<thead>
  <tr>
    ...
    <th style="width:100px;text-align:center;">Área de Almacenaje</th>
  </tr>
</thead>
                  @foreach ($repuestos as $reps)

<tr>
  <td style="width:100px;text-align:center;">{{ $reps->codigo }}</td>
  <td style="width:100px;text-align:center;">{{ $reps->descripcion }}</td>
  <td style="width:100px;text-align:center;">{{ $reps->marca }}</td>
  <td style="width:100px;text-align:center;">{{ $reps->area }}</td>
</tr>
                  @endforeach
