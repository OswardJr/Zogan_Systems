...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Propietarios Totales</h3>
...
@foreach ($propietarios as $props)

<tr>
  <td style="width:100px;text-align:center;">{{ $props->rif }}</td>
  <td style="width:100px;text-align:center;">{{ $props->nombre_completo }}</td>
  <td style="width:100px;text-align:center;">{{ $props->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $props->email }}</td>
</tr>
  @endforeach
