                                 ...
                                 <form method="post" action=" {{ url('/aseguradoras/') }}/{{ $aseguradoras->id }}">
                                   ...
                                   <input required="true" type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div class="form-group col-xs-6">
                                      ...
                                      <input type="text" name="denominacion" id="" class="form-control" value="{{ $aseguradoras->denominacion }}" placeholder="Seguros Caracas C.A" required="true">
                                    </div>
                                    <div class="form-group col-xs-6">
                                      <label>Teléfono<a class="campos-required" title="Campo Obligatorio."> *</a></label>
                                      <input type="text" name="telefono" id="" value="{{ $aseguradoras->telefono }}" pattern="^([0-9]{4})-([0-9]{7})$" class="form-control" placeholder="0212-XXXXXXX">
                                    </div>
                                    <div class="form-group col-xs-6">
                                      <label>Email<a class="campos-required" title="Campo Obligatorio."> *</a></label>
                                      <input type="email" name="email" id="email" class="form-control" value="{{ $aseguradoras->email }}" placeholder="contact@example.com">
                                    </div>
