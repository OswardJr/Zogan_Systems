...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Aseguradoras Totales</h3>

    <table class="collapse">
<thead>
  <tr>
    <th style="width:100px;text-align:center;">Rif</th>
    <th style="width:100px;text-align:center;">Denominación</th>
...
<tr>
  <td style="width:100px;text-align:center;">{{ $asegu->rif }}</td>
  <td style="width:100px;text-align:center;">{{ $asegu->denominacion }}</td>
  <td style="width:100px;text-align:center;">{{ $asegu->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $asegu->email }}</td>
</tr>
                  @endforeach
