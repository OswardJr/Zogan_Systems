      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body ">
          ...
          <div class="form-group col-lg-4">
            ...
            <input type="text" name="nombre_completo" id="" class="form-control" placeholder="Pacheco Requena Osward José" required="true" >
          </div>
          <div class="form-group col-lg-4">
...
>>>>>>> a51a0377e66041ed1834d7e1c9d9035fe498add8
          <div class="form-group col-lg-4">
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body ">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" name="marca" id="" class="form-control" placeholder="CHEVROLET" required="true" >
            </div>
            <div class="form-group col-md-3">
              <label>Modelo:<a class="campos-required" pattern="[A-Z]" title="Campo Obligatorio."> *</a></label>
              <input type="text" name="modelo" id="" class="form-control" placeholder="NHR" required="true" >
            </div>
            <div class="form-group col-md-3">
              <label>Tipo:<a class="campos-required" title="Campo Obligatorio."> *</a></label>
              <input type="text" name="tipo" id="" class="form-control" placeholder="FURGÓN" required="true" >
            </div>
            <div class="form-group col-md-3">
    ...
    <div class="panel panel-primary ">
      ...
      <div class="panel-body">
        <div class="form-group col-md-6 ">
          ...
          <textarea type="text" name="descripcion_daños" placeholder="PUERTA DERECHA (CAMIÓN)" class="form-control"></textarea>
        </div>
        <div class="form-group col-md-6 ">
          <label>Tipo de Daño</label>
          <textarea type="text" name="tipos_daños" placeholder="REPARAR Y PINTAR INSTALAR" class="form-control"></textarea>
        </div>
    ...
    <div class="panel panel-primary ">
      ...
      <div class="panel-body ">
        <div class="form-group col-md-6 ">
          ...
          <textarea type="text" name="selec_repues" placeholder="PUERTA DERECHA (CAMIÓN)" class="form-control"></textarea>
        </div>
        <div class="form-group col-md-6 ">
          <label>Repuestos No Disponibles</label>
          <textarea type="text" name="no_dispo" placeholder="REPARAR Y PINTAR INSTALAR" class="form-control"></textarea>
        </div>
      </div>
    </div>
