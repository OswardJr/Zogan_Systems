...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Órdenes de Reparación Totales</h3>
...
<thead>
  <tr>
    ...
    <th style="width:100px;text-align:center;">Analista</th>
  </tr>
</thead>
                  @foreach ($reparaciones as $repar)

<tr>
  <td style="width:100px;text-align:center;">{{ $repar->placa }}</td>
  <td style="width:100px;text-align:center;">{{ $repar->nombre_completo }}</td>
  <td style="width:100px;text-align:center;">{{ $repar->modelo }}</td>
  <td style="width:100px;text-align:center;">{{ $repar->nombre }}</td>
</tr>
                  @endforeach
