              ...
              <table data-toggle="table" class="table table-bordered table-striped">
                ...
                <tbody class="buscar">
                  ...
                  <tr>
                    ...
                    <td>{{ ($repar->nombre) }}</td>
                    <td>                      
                      <a href="{{action('ReparacionesController@downloadPDF', $repar->id)}}" class="btn btn-default" target="_blank" data-toggle="tooltip" title="Descargar"><i class="fa fa-download"></i>
                       </a>
                    </td> 
                  </tr>
                  @endforeach
