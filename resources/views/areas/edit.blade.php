                                   ...
                                   <input required="true" type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <div class="form-group col-xs-6 " style="margin-bottom: 0px; height: 60px">
                                      <label>Código<a class="campos-required" title="Campo Obligatorio."> *</a></label>
                                        <input type="text" name="codigo" id="" class="form-control " title="El formato debe ser J-12345678-9"  placeholder="A0001" onkeyup="this.value=this.value.toUpperCase()" value="{{ $areas->codigo }}" required="true" >
                                    </div>
