...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Corredores Totales</h3>
...
<thead>
  <tr>
    ...
    <th style="width:100px;text-align:center;">Correo</th>
                  ...
                  @foreach ($corredores as $correds)

<tr>
  <td style="width:100px;text-align:center;">{{ $correds->cedula }}</td>
  <td style="width:100px;text-align:center;">{{ $correds->nombre }}</td>
  <td style="width:100px;text-align:center;">{{ $correds->apellido }}</td>
  <td style="width:100px;text-align:center;">{{ $correds->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $correds->email }}</td>
</tr>
                  @endforeach
