          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body ">
              ...
              <div class="form-group col-xs-6">
                ...
                <input type="text" name="celular" id="" value="{{ old('celular') }}" pattern="^([0-9]{4})-([0-9]{7})$" class="form-control" maxlength="11" onkeypress="return justNumbers(event);" title="El formato debe ser 04241234567" placeholder="0412-XXXXXXX" onkeyup="this.value=this.value.toUpperCase()" required="true">
              </div>
              <div class="form-group col-xs-6">
                <label>Teléfono<a class="campos-required" title="Campo Obligatorio."> *</a></label>
                <input type="text" name="telefono" id="" value="{{ old('telefono') }}" pattern="^([0-9]{4})([0-9]{7})$" class="form-control" maxlength="11" onkeypress="return justNumbers(event);" title="El formato debe ser 02441234567" placeholder="0244XXXXXXX" onkeyup="this.value=this.value.toUpperCase()" required="true">
              </div>
              <div class="form-group col-xs-6">
