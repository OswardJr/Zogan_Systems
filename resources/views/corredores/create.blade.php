            ...
            <div class="panel-body ">
              <form method="post" name="crear" id="crear" action="{{ url('/corredores') }}">
               ...
               <div class="form-group col-xs-6 " style="margin-bottom: 0px; height: 60px">
                ...
                <input type="text" name="cedula" id="" class="form-control " pattern="^([JVEG]{1})-([0-9]{8})-([0-9]{1})$" title="El formato debe ser J-12345678-9" value="{{ old('cedula') }}"  placeholder="J-12345678-9" onkeyup="this.value=this.value.toUpperCase()" value="" required="true" >
