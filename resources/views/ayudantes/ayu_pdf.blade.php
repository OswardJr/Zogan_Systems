...
h3 {
  ...
  background: url("http://localhost/Zogan_Systems/public/img/dimension.png");
    ...
    <h3>Listado de Ayudantes Totales</h3>
...
<thead>
  <tr>
    ...
    <th style="width:100px;text-align:center;">Correo</th>
                  ...
                  @foreach ($ayudantes as $ayus)

<tr>
  <td style="width:100px;text-align:center;">{{ $ayus->cedula }}</td>
  <td style="width:100px;text-align:center;">{{ $ayus->nombre }}</td>
  <td style="width:100px;text-align:center;">{{ $ayus->apellido }}</td>
  <td style="width:100px;text-align:center;">{{ $ayus->telefono }}</td>
  <td style="width:100px;text-align:center;">{{ $ayus->email }}</td>
</tr>
                  @endforeach
