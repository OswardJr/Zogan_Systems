                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="panel-body ">
                                  <form method="post" action=" {{ url('/ayudantes/') }}/{{ $ayudantes->id }}">
                                   ...
                                   <input required="true" type="hidden" name="_token" value="{{ csrf_token() }}">                                    
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="cedula" value="{{ $ayudantes->cedula }}" id="" class="form-control" placeholder="José" required="true" disabled>
                                    </div>
                                  </div>  
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="nombre" value="{{ $ayudantes->nombre }}" id="" class="form-control" placeholder="José" required="true" disabled>
                                    </div>
                                  </div>  
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="apellido" value="{{ $ayudantes->apellido }}" id="" class="form-control" placeholder="Pérez" required="true" disabled>
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="telefono" value="{{ $ayudantes->telefono }}" id="" pattern="^([0-9]{4})-([0-9]{7})$" class="form-control" placeholder="0244-XXXXXXX" disabled>
                                    </div>
                                  </div>  
                                    <div class="form-group col-md-6">
                                      <div class="form-group @if ($errors->has('email')) has-error @endif">                                     
                                      <label>Email</label>
                                      <input type="email" name="email" value="{{ $ayudantes->email }}" id="email" class="form-control" placeholder="contact@example.com" disabled>
                                    </div>
                                  </div>  
                                    <!-- textarea -->
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="text" name="direccion" value="{{ $ayudantes->direccion }}" id="" class="form-control" placeholder="Dirección" disabled></input>
                                    </div>
                                  </div>  
