            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="panel panel-default">
                        <center><div class="panel-heading"><h4>Actualización del Usuario</h4></div></center>
                        <div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="actpassword" type="password" placeholder="Contraseña Actual" class="form-control" name="actpassword" required>

                                    @if ($errors->has('password'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('actpassword') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
